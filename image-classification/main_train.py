...
parser.add_argument('--saw_method', type=str, default='linear')
parser.add_argument('--saw_k', type=int, default=0)
parser.strict = False
saw_opts, unknown_args = parser.parse_known_args()
import os
os.environ["SAW_METHOD"] = saw_opts.saw_method
os.environ["SAW_K"] = str(saw_opts.saw_k)
# print(saw_opts)
