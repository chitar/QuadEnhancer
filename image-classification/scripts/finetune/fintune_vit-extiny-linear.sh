...
epoch=100
pretrained_model=".formal_res/vit-extiny-linear/checkpoint_ema_best.pt"
...
run_label="fintune-vit-extiny-linear-$setname"
...
\
 --common.config-file scripts/finetune/finetune-vit-extiny.yaml \
 --common.results-loc formal_res/finetuning \
 --saw_method roll --saw_k 0  \
