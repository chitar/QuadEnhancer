...
epoch=100
pretrained_model=".formal_res/vit-micro-linear/checkpoint_ema_best.pt"
...
run_label="fintune-vit-micro-linear-$setname"
...
\
 --common.config-file scripts/finetune/finetune-vit-micro.yaml \
